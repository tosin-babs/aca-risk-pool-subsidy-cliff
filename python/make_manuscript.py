...
Produces, in manuscript/:
  Paper4_Babalola.docx  - what most journals want uploaded
  Paper4_Babalola.pdf   - for reading and for the preprint server
...
SRC = MS / "Paper4_manuscript.md"
TABLES = MS / "tables.md"
COMBINED = MS / ".combined.md"
DOCX = MS / "Paper4_Babalola.docx"
PDF = MS / "Paper4_Babalola.pdf"
HTML = MS / ".paper.html"
